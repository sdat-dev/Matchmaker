...
let keyss=fs.readFileSync('C:/Users/sg797751/Desktop/GIt/Matchmaker/JSONs/SPIN_Keywords.json')
...
async function main() {
    ...
    // Uncomment below
    fs.writeFileSync(path.join(directory2, 'keyIdArr.json'), JSON.stringify(dict2));
    // console.log(dict);
    // mostUsedWords(dict);
